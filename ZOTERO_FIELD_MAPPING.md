...
| Author | Author names | Andersson, Lars<br>Svensson, Olof | Enter as: Last, First<br>Output: Andersson L, Svensson O |
...
| Author | Author names | Smith, John<br>Brown, Robert | Enter as: Last, First<br>Output: Smith J, Brown R |
...
| Editor | Book editor | Wilson, David | Enter as: Last, First<br>Output: Wilson D, editor |
...
### Example Output (Unpublished Paper)
...
### Example Output (Published in Proceedings)
